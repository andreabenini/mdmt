...
echo -e "\033[0;96m- Splitting   README.md by header 1\033[0;90m"
echo -e "  "./mdmt --input=./tests/README.md --output=./tests/output/ --template=./templates/mdmt.css --header-split 1
